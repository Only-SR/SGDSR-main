...
def parse_args():
   ...
   #Configuration Arguments
    ...
    parser.add_argument('--cuda1',   type=str, default='1')
   ...
   #Model Arguments
    ...
    parser.add_argument('--n_lay',  type=int,   default=2)
    parser.add_argument('--s_lay', type=int, default=2)
    ...
    parser.add_argument('--lr1',         type=float, default=5e-3)
    parser.add_argument('--lr2',         type=float, default=5e-3)
    parser.add_argument('--lr',         type=float, default=5e-3)
    parser.add_argument('--difflr1', type=float, default=1e-3)
    parser.add_argument('--difflr2', type=float, default=1e-3)
    parser.add_argument('--difflr', type=float, default=1e-3)
    parser.add_argument('--reg1',        type=float, default=1e-2)
    parser.add_argument('--reg2',        type=float, default=1e-2)
